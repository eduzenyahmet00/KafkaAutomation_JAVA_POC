...
public class KafkaExample {
    ...
    public KafkaExample(String brokers, String username, String password) {
        ...
        props.put("group.id", username + "-ahmet");
    ...
    public static void main(String[] args) {
        String brokers = System.getenv("dory.srvs.cloudkafka.com:9094");
        String username = System.getenv("shetjzgv");
        String password = System.getenv("ttGUKSaFvZ9iHA503YvL4OaWF5-4GSLi");
